...
public class Lacos24 {
    ...
    int i = 0;i<3;i++)
    {
        ...
        curso = Integer.parseInt(JOptionPane.showInputDialog(null,
                "Escolha seu curso:" + "\n" + "1 - Letras" + "\n" + "2 - Matematica" + "\n" + "3 - Biologia"));
        ingre = Integer.parseInt(JOptionPane.showInputDialog(null, "Escolha sua forma de ingresso: " + "\n"
                + "1 - Vestibular" + "\n" + "2 - Transferência" + "\n" + "3 - ENEM"));
        sem = Integer.parseInt(JOptionPane.showInputDialog(null,
                "Digite o semestre que voçê entrou:" + "\n" + " 1-1º semestre" + "\n" + " 2-2º semestre"));
